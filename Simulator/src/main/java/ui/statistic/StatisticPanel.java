...
public final class StatisticPanel extends StatisticBasePanel {
	...
	private MultiNumbers[] callerTypes(Statistics data[]) {
		...
		return list.toArray(MultiNumbers[]::new);
	}
	...
	private void addStatisticToTree(StatisticNode root, Statistics data[]) {
		...
		root.addChild(new StatisticNode(Language.tr("SimStatistic.ResultOverview"),list.toArray(StatisticViewer[]::new),Language.tr("SimStatistic.Category.General")));
		...
		root.addChild(new StatisticNode(Language.tr("SimStatistic.ModelInformation"),list.toArray(StatisticViewer[]::new),Language.tr("SimStatistic.Category.General")));
		...
		root.addChild(new StatisticNode(Language.tr("SimStatistic.ConfidenceIntervals"),list.toArray(StatisticViewer[]::new),Language.tr("SimStatistic.Category.General")));
		...
		root.addChild(new StatisticNode(Language.tr("SimStatistic.ThresholdsAndRecommendations"),list.toArray(StatisticViewer[]::new),Language.tr("SimStatistic.Category.General")));
		...
		node2.addChild(new StatisticNode(Language.tr("SimStatistic.Overview"),list.toArray(StatisticViewer[]::new)));
		...
		node3.addChild(new StatisticNode(Language.tr("SimStatistic.FreshCalls"),list.toArray(StatisticViewer[]::new)));
		...
		node3.addChild(new StatisticNode(Language.tr("SimStatistic.Calls"),list.toArray(StatisticViewer[]::new)));
		...
		node3.addChild(new StatisticNode(Language.tr("SimStatistic.RecallingClients"),list.toArray(StatisticViewer[]::new)));
		...
		node3.addChild(new StatisticNode(Language.tr("SimStatistic.CanceledCalls"),list.toArray(StatisticViewer[]::new)));
		...
		node3.addChild(new StatisticNode(Language.tr("SimStatistic.ForwardedCalls"),list.toArray(StatisticViewer[]::new)));
		...
		node3.addChild(new StatisticNode(Language.tr("SimStatistic.RetryCalls"),list.toArray(StatisticViewer[]::new)));
		...
		node2.addChild(new StatisticNode(Language.tr("SimStatistic.FreshCalls"),list.toArray(StatisticViewer[]::new)));
		...
		node2.addChild(new StatisticNode(Language.tr("SimStatistic.RecallingClients"),list.toArray(StatisticViewer[]::new)));
		...
		node2.addChild(new StatisticNode(Language.tr("SimStatistic.Calls"),list.toArray(StatisticViewer[]::new)));
		...
		node2.addChild(new StatisticNode(Language.tr("SimStatistic.ForwardedCalls.Number"),list.toArray(StatisticViewer[]::new)));
		...
		node2.addChild(new StatisticNode(Language.tr("SimStatistic.ForwardedCalls.Part"),list.toArray(StatisticViewer[]::new)));
		...
		node2.addChild(new StatisticNode(Language.tr("SimStatistic.RetryCalls"),list.toArray(StatisticViewer[]::new)));
		...
		if (caller.length>1) for (MultiNumbers m : caller) {
			...
			node2.addChild(new StatisticNode(m.name,list.toArray(StatisticViewer[]::new),Language.tr("SimStatistic.Category.NumberOfCallersOverTheDay.PerCallerType")));
		}
		...
		node2.addChild(new StatisticNode(Language.tr("SimStatistic.AllClients"),list.toArray(StatisticViewer[]::new)));
		...
		node2.addChild(new StatisticNode(Language.tr("SimStatistic.WaitingTimes")+" ("+Language.tr("SimStatistic.OnClientBasis")+")",list.toArray(StatisticViewer[]::new),Language.tr("SimStatistic.Category.WaitingTimesPerCallerType.SingleGraphics")));
		...
		node2.addChild(new StatisticNode(Language.tr("SimStatistic.WaitingTimes")+" ("+Language.tr("SimStatistic.OnCallBasis")+")",list.toArray(StatisticViewer[]::new),Language.tr("SimStatistic.Category.WaitingTimesPerCallerType.SingleGraphics")));
		...
		node2.addChild(new StatisticNode(Language.tr("SimStatistic.ResidenceTimes")+" ("+Language.tr("SimStatistic.OnClientBasis")+")",list.toArray(StatisticViewer[]::new),Language.tr("SimStatistic.Category.WaitingTimesPerCallerType.SingleGraphics")));
		...
		node2.addChild(new StatisticNode(Language.tr("SimStatistic.ResidenceTimes")+" ("+Language.tr("SimStatistic.OnCallBasis")+")",list.toArray(StatisticViewer[]::new),Language.tr("SimStatistic.Category.WaitingTimesPerCallerType.SingleGraphics")));
		...
		node2.addChild(new StatisticNode(Language.tr("SimStatistic.WaitingAndResidenceTimes")+" ("+Language.tr("SimStatistic.OnClientBasis")+")",list.toArray(StatisticViewer[]::new)));
		...
		node2.addChild(new StatisticNode(Language.tr("SimStatistic.WaitingAndResidenceTimes")+" ("+Language.tr("SimStatistic.OnCallBasis")+")",list.toArray(StatisticViewer[]::new)));
		...
		node2.addChild(new StatisticNode(Language.tr("SimStatistic.WaitingTimesDistribution")+" ("+Language.tr("SimStatistic.OnClientBasis")+")",list.toArray(StatisticViewer[]::new)));
		...
		node2.addChild(new StatisticNode(Language.tr("SimStatistic.WaitingTimesDistribution")+" ("+Language.tr("SimStatistic.OnCallBasis")+")",list.toArray(StatisticViewer[]::new)));
		...
		node2.addChild(new StatisticNode(Language.tr("SimStatistic.WaitingTimesDistribution")+" ["+Language.tr("SimStatistic.long")+"] ("+Language.tr("SimStatistic.OnClientBasis")+")",list.toArray(StatisticViewer[]::new)));
		...
		node2.addChild(new StatisticNode(Language.tr("SimStatistic.WaitingTimesDistribution")+" ["+Language.tr("SimStatistic.long")+"] ("+Language.tr("SimStatistic.OnCallBasis")+")",list.toArray(StatisticViewer[]::new)));
		...
		node2.addChild(new StatisticNode(Language.tr("SimStatistic.ResidenceTimesDistribution")+" ("+Language.tr("SimStatistic.OnClientBasis")+")",list.toArray(StatisticViewer[]::new)));
		...
		node2.addChild(new StatisticNode(Language.tr("SimStatistic.ResidenceTimesDistribution")+" ("+Language.tr("SimStatistic.OnCallBasis")+")",list.toArray(StatisticViewer[]::new)));
		...
		node2.addChild(new StatisticNode(Language.tr("SimStatistic.ResidenceTimesDistribution")+" ["+Language.tr("SimStatistic.long")+"] ("+Language.tr("SimStatistic.OnClientBasis")+")",list.toArray(StatisticViewer[]::new)));
		...
		node2.addChild(new StatisticNode(Language.tr("SimStatistic.ResidenceTimesDistribution")+" ["+Language.tr("SimStatistic.long")+"] ("+Language.tr("SimStatistic.OnCallBasis")+")",list.toArray(StatisticViewer[]::new)));
		if (caller.length>1) for (MultiNumbers m : caller) {
			...
			node2.addChild(new StatisticNode(m.name+" ("+Language.tr("SimStatistic.OnClientBasis")+")",list.toArray(StatisticViewer[]::new),Language.tr("SimStatistic.Category.WaitingAndResidenceTimesDistribution.PerCallerType")));
			...
			node2.addChild(new StatisticNode(m.name+" ("+Language.tr("SimStatistic.OnCallBasis")+")",list.toArray(StatisticViewer[]::new),Language.tr("SimStatistic.Category.WaitingAndResidenceTimesDistribution.PerCallerType")));
			...
			node2.addChild(new StatisticNode(m.name+" ["+Language.tr("SimStatistic.long")+"] ("+Language.tr("SimStatistic.OnClientBasis")+")",list.toArray(StatisticViewer[]::new),Language.tr("SimStatistic.Category.WaitingAndResidenceTimesDistribution.PerCallerType")));
			...
			node2.addChild(new StatisticNode(m.name+" ["+Language.tr("SimStatistic.long")+"] ("+Language.tr("SimStatistic.OnCallBasis")+")",list.toArray(StatisticViewer[]::new),Language.tr("SimStatistic.Category.WaitingAndResidenceTimesDistribution.PerCallerType")));
		}
		...
		node2.addChild(new StatisticNode(Language.tr("SimStatistic.AllClients")+" ("+Language.tr("SimStatistic.OnClientBasis")+")",list.toArray(StatisticViewer[]::new)));
		...
		node2.addChild(new StatisticNode(Language.tr("SimStatistic.AllClients")+" ("+Language.tr("SimStatistic.OnCallBasis")+")",list.toArray(StatisticViewer[]::new)));
		...
		node2.addChild(new StatisticNode(Language.tr("SimStatistic.AllClients")+" ["+Language.tr("SimStatistic.long")+"] ("+Language.tr("SimStatistic.OnClientBasis")+")",list.toArray(StatisticViewer[]::new)));
		...
		node2.addChild(new StatisticNode(Language.tr("SimStatistic.AllClients")+" ["+Language.tr("SimStatistic.long")+"] ("+Language.tr("SimStatistic.OnCallBasis")+")",list.toArray(StatisticViewer[]::new)));
		...
		node2.addChild(new StatisticNode(Language.tr("SimStatistic.Overview")+" ("+Language.tr("SimStatistic.OnClientBasis")+")",list.toArray(StatisticViewer[]::new)));
		...
		node2.addChild(new StatisticNode(Language.tr("SimStatistic.Overview")+" ("+Language.tr("SimStatistic.OnCallBasis")+")",list.toArray(StatisticViewer[]::new)));
		...
		node2.addChild(new StatisticNode(Language.tr("SimStatistic.Overview")+" ["+Language.tr("SimStatistic.long")+"] ("+Language.tr("SimStatistic.OnClientBasis")+")",list.toArray(StatisticViewer[]::new)));
		...
		node2.addChild(new StatisticNode(Language.tr("SimStatistic.Overview")+" ["+Language.tr("SimStatistic.long")+"] ("+Language.tr("SimStatistic.OnCallBasis")+")",list.toArray(StatisticViewer[]::new)));
		if (caller.length>1) for (MultiNumbers m : caller) {
			...
			node2.addChild(new StatisticNode(m.name+" ("+Language.tr("SimStatistic.OnClientBasis")+")",list.toArray(StatisticViewer[]::new),"Abbruchzeitverteilung - pro Kundentyp"));
			...
			node2.addChild(new StatisticNode(m.name+" ("+Language.tr("SimStatistic.OnCallBasis")+")",list.toArray(StatisticViewer[]::new),"Abbruchzeitverteilung - pro Kundentyp"));
			...
			node2.addChild(new StatisticNode(m.name+" ["+Language.tr("SimStatistic.long")+"] ("+Language.tr("SimStatistic.OnClientBasis")+")",list.toArray(StatisticViewer[]::new),Language.tr("SimStatistic.Category.CancelTimesDistribution.PerCallerType")));
			...
			node2.addChild(new StatisticNode(m.name+" ["+Language.tr("SimStatistic.long")+"] ("+Language.tr("SimStatistic.OnCallBasis")+")",list.toArray(StatisticViewer[]::new),Language.tr("SimStatistic.Category.CancelTimesDistribution.PerCallerType")));
		}
		...
		node2.addChild(new StatisticNode(Language.tr("SimStatistic.WaitingTimes")+" ("+Language.tr("SimStatistic.OnClientBasis")+")",list.toArray(StatisticViewer[]::new)));
		...
		node2.addChild(new StatisticNode(Language.tr("SimStatistic.WaitingTimes")+" ("+Language.tr("SimStatistic.OnCallBasis")+")",list.toArray(StatisticViewer[]::new)));
		...
		node2.addChild(new StatisticNode(Language.tr("SimStatistic.ResidenceTimes")+" ("+Language.tr("SimStatistic.OnClientBasis")+")",list.toArray(StatisticViewer[]::new)));
		...
		node2.addChild(new StatisticNode(Language.tr("SimStatistic.ResidenceTimes")+" ("+Language.tr("SimStatistic.OnCallBasis")+")",list.toArray(StatisticViewer[]::new)));
		...
		node2.addChild(new StatisticNode(Language.tr("SimStatistic.CancelTimes")+" ("+Language.tr("SimStatistic.OnClientBasis")+")",list.toArray(StatisticViewer[]::new)));
		...
		node2.addChild(new StatisticNode(Language.tr("SimStatistic.CancelTimes")+" ("+Language.tr("SimStatistic.OnCallBasis")+")",list.toArray(StatisticViewer[]::new)));
		if (caller.length>1) for (MultiNumbers m : caller) {
			...
			node2.addChild(new StatisticNode(m.name+" ("+Language.tr("SimStatistic.OnClientBasis")+")",list.toArray(StatisticViewer[]::new),Language.tr("SimStatistic.Category.WaitingTimesOverTheDay.PerCallerType")));
			...
			node2.addChild(new StatisticNode(m.name+" ("+Language.tr("SimStatistic.OnCallBasis")+")",list.toArray(StatisticViewer[]::new),Language.tr("SimStatistic.Category.WaitingTimesOverTheDay.PerCallerType")));
		}
		...
		node2.addChild(new StatisticNode(Language.tr("SimStatistic.SuccessfulCalls")+" ("+Language.tr("SimStatistic.Number")+")",list.toArray(StatisticViewer[]::new)));
		...
		node2.addChild(new StatisticNode(Language.tr("SimStatistic.SuccessfulCalls")+" ("+Language.tr("SimStatistic.Part")+")",list.toArray(StatisticViewer[]::new)));
		...
		node2.addChild(new StatisticNode(Language.tr("SimStatistic.SuccessfulClients")+" ("+Language.tr("SimStatistic.Number")+")",list.toArray(StatisticViewer[]::new)));
		...
		node2.addChild(new StatisticNode(Language.tr("SimStatistic.SuccessfulClients")+" ("+Language.tr("SimStatistic.Part")+")",list.toArray(StatisticViewer[]::new)));
		...
		node2.addChild(new StatisticNode(Language.tr("SimStatistic.CanceledCalls")+" ("+Language.tr("SimStatistic.Number")+")",list.toArray(StatisticViewer[]::new)));
		...
		node2.addChild(new StatisticNode(Language.tr("SimStatistic.CanceledCalls")+" ("+Language.tr("SimStatistic.Part")+")",list.toArray(StatisticViewer[]::new)));
		...
		node2.addChild(new StatisticNode(Language.tr("SimStatistic.CanceledCallers")+" ("+Language.tr("SimStatistic.Number")+")",list.toArray(StatisticViewer[]::new)));
		...
		node2.addChild(new StatisticNode(Language.tr("SimStatistic.CanceledCallers")+" ("+Language.tr("SimStatistic.Part")+")",list.toArray(StatisticViewer[]::new)));
		if (caller.length>1) for (MultiNumbers m : caller) {
			...
			node2.addChild(new StatisticNode(m.name+" ("+Language.tr("SimStatistic.OnClientBasis")+")",list.toArray(StatisticViewer[]::new),Language.tr("SimStatistic.Category.AccessibilityOverTheDay.PerCallerType")));
			...
			node2.addChild(new StatisticNode(m.name+" ("+Language.tr("SimStatistic.OnCallBasis")+")",list.toArray(StatisticViewer[]::new),Language.tr("SimStatistic.Category.AccessibilityOverTheDay.PerCallerType")));
		}
		...
		node2.addChild(new StatisticNode(Language.tr("SimStatistic.Overview")+" ("+Language.tr("SimStatistic.CalculatedOn.SuccessfulClients")+")",list.toArray(StatisticViewer[]::new)));
		...
		node2.addChild(new StatisticNode(Language.tr("SimStatistic.Overview")+" ("+Language.tr("SimStatistic.CalculatedOn.SuccessfulCalls")+")",list.toArray(StatisticViewer[]::new)));
		...
		node2.addChild(new StatisticNode(Language.tr("SimStatistic.Overview")+" ("+Language.tr("SimStatistic.CalculatedOn.AllClients")+")",list.toArray(StatisticViewer[]::new)));
		...
		node2.addChild(new StatisticNode(Language.tr("SimStatistic.Overview")+" ("+Language.tr("SimStatistic.CalculatedOn.AllCalls")+")",list.toArray(StatisticViewer[]::new)));
		...
		if (caller.length>1) for (MultiNumbers m : caller) {
			...
			node2.addChild(new StatisticNode(m.name+" ("+Language.tr("SimStatistic.CalculatedOn.SuccessfulClients")+")",list.toArray(StatisticViewer[]::new),Language.tr("SimStatistic.Category.ServiceLevelOverTheDay.PerCallerType")));
			...
			node2.addChild(new StatisticNode(m.name+" ("+Language.tr("SimStatistic.CalculatedOn.SuccessfulCalls")+")",list.toArray(StatisticViewer[]::new),Language.tr("SimStatistic.Category.ServiceLevelOverTheDay.PerCallerType")));
			...
			node2.addChild(new StatisticNode(m.name+" ("+Language.tr("SimStatistic.CalculatedOn.AllClients")+")",list.toArray(StatisticViewer[]::new),Language.tr("SimStatistic.Category.ServiceLevelOverTheDay.PerCallerType")));
			...
			node2.addChild(new StatisticNode(m.name+" ("+Language.tr("SimStatistic.CalculatedOn.AllCalls")+")",list.toArray(StatisticViewer[]::new),Language.tr("SimStatistic.Category.ServiceLevelOverTheDay.PerCallerType")));
		}
		...
		node2.addChild(new StatisticNode(Language.tr("SimStatistic.AllClients")+" ("+Language.tr("SimStatistic.CalculatedOn.SuccessfulClients")+")",list.toArray(StatisticViewer[]::new)));
		...
		node2.addChild(new StatisticNode(Language.tr("SimStatistic.AllClients")+" ("+Language.tr("SimStatistic.CalculatedOn.SuccessfulCalls")+")",list.toArray(StatisticViewer[]::new)));
		...
		node2.addChild(new StatisticNode(Language.tr("SimStatistic.AllClients")+" ("+Language.tr("SimStatistic.CalculatedOn.AllClients")+")",list.toArray(StatisticViewer[]::new)));
		...
		node2.addChild(new StatisticNode(Language.tr("SimStatistic.AllClients")+" ("+Language.tr("SimStatistic.CalculatedOn.AllCalls")+")",list.toArray(StatisticViewer[]::new)));
		...
		if (agentsCallcenter.length>1) for (MultiNumbers m: agentsCallcenter) {
			...
			node2.addChild(new StatisticNode(m.name,list.toArray(StatisticViewer[]::new),Language.tr("SimStatistic.Category.WorkLoadPerCallcenter.SingleGraphics")));
		}
		...
		node2.addChild(new StatisticNode(Language.tr("SimStatistic.AllCallcenter"),list.toArray(StatisticViewer[]::new)));
		if (agentsCallcenter.length>1) for (MultiNumbers m: agentsCallcenter) {
			...
			node2.addChild(new StatisticNode(m.name+" ("+Language.tr("SimStatistic.Detailed")+")",list.toArray(StatisticViewer[]::new),Language.tr("SimStatistic.Category.WorkLoadPerCallcenter.SingleGraphics")));
		}
		...
		node2.addChild(new StatisticNode(Language.tr("SimStatistic.AllCallcenter")+" ("+Language.tr("SimStatistic.Detailed")+")",list.toArray(StatisticViewer[]::new)));
		...
		node2.addChild(new StatisticNode(Language.tr("SimStatistic.Overview")+" ("+Language.tr("SimStatistic.Detailed")+")",list.toArray(StatisticViewer[]::new)));
		...
		node2.addChild(new StatisticNode(Language.tr("SimStatistic.NumberOfCalls"),list.toArray(StatisticViewer[]::new)));
		if (agentsCallcenter.length>1) for (MultiNumbers m: agentsCallcenter) {
			...
			node2.addChild(new StatisticNode(m.name,list.toArray(StatisticViewer[]::new),Language.tr("SimStatistic.Category.WorkLoadOverTheDay.SingleGraphics")));
		}
		...
		if (agentsCallcenter.length>1) for (MultiNumbers m: agentsCallcenter) {
			...
			node2.addChild(new StatisticNode(m.name+" ("+Language.tr("SimStatistic.Detailed")+")",list.toArray(StatisticViewer[]::new),Language.tr("SimStatistic.Category.WorkLoadOverTheDay.SingleGraphics")));
		}
		...
		node2.addChild(new StatisticNode(Language.tr("SimStatistic.Queue"),list.toArray(StatisticViewer[]::new)));
		...
		if (agentsCallcenter.length>1) for (MultiNumbers m: agentsCallcenter) {
			...
			node2.addChild(new StatisticNode(m.name,list.toArray(StatisticViewer[]::new),Language.tr("SimStatistic.Category.IdleTimeOverTheDay.SingleGraphics")));
		}
		...
		if (agentsSkills.length>1) for (MultiNumbers m: agentsSkills) {
			...
			node2.addChild(new StatisticNode(m.name,list.toArray(StatisticViewer[]::new),Language.tr("SimStatistic.Category.WorkLoadPerSkillLevel.SingleGraphics")));
		}
		if (agentsSkills.length>1) for (MultiNumbers m: agentsSkills) {
			...
			node2.addChild(new StatisticNode(m.name+" ("+Language.tr("SimStatistic.Detailed")+")",list.toArray(StatisticViewer[]::new),Language.tr("SimStatistic.Category.WorkLoadPerSkillLevel.SingleGraphics")));
		}
		...
		node.addChild(node2=new StatisticNode(Language.tr("SimStatistic.AgentsOnModelBasis.AgentsInSimulation"),list.toArray(StatisticViewer[]::new),Language.tr("SimStatistic.Category.AgentsOnModelBasis")));
		...
		node.addChild(node2=new StatisticNode(Language.tr("SimStatistic.AgentsOnModelBasis.AgentsInModel"),list.toArray(StatisticViewer[]::new),Language.tr("SimStatistic.Category.AgentsOnModelBasis")));
		...
		node.addChild(node2=new StatisticNode(Language.tr("SimStatistic.AgentsOnModelBasis.AgentsWithAddition"),list.toArray(StatisticViewer[]::new),Language.tr("SimStatistic.Category.AgentsOnModelBasis")));
		...
		node.addChild(node2=new StatisticNode(Language.tr("SimStatistic.ErlangCComparison.Success"),list.toArray(StatisticViewer[]::new),Language.tr("SimStatistic.Category.ErlangCComparison")));
		...
		node.addChild(node2=new StatisticNode(Language.tr("SimStatistic.ErlangCComparison.WaitingTime"),list.toArray(StatisticViewer[]::new),Language.tr("SimStatistic.Category.ErlangCComparison")));
		...
		node.addChild(node2=new StatisticNode(Language.tr("SimStatistic.ErlangCComparison.ServiceLevel"),list.toArray(StatisticViewer[]::new),Language.tr("SimStatistic.Category.ErlangCComparison")));
		...
		root.addChild(new StatisticNode(Language.tr("SimStatistic.Costs"),list.toArray(StatisticViewer[]::new),Language.tr("SimStatistic.Costs")));
		...
		root.addChild(new StatisticNode(Language.tr("SimStatistic.SystemData"),list.toArray(StatisticViewer[]::new),Language.tr("SimStatistic.Category.General")));
