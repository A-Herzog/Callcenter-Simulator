...
public class FlatLaFHelper {
	 ...
	 * Diese Klasse stellt nur statische Hilfsfunktionen zur Verfügung
	 * und kann nicht instanziert werden.
	 */
	private FlatLaFHelper() {
		/*
	...
	public static class TaskDialogWindowsDarkCommandLinkPainter extends WindowsCommandLinkPainter {
		...
		private final LinkChrome selectedChrome=new LinkChrome(Color.GRAY,Color.DARK_GRAY,Color.GRAY,1,7);
		/** {@link WindowsCommandLinkPainter} */
		private final LinkChrome armedChrome=new LinkChrome(Color.LIGHT_GRAY,Color.GRAY,new Color(0xB9D7FC),1,7);
		/** {@link WindowsCommandLinkPainter} */
		private final LinkChrome rolloverChrome=new LinkChrome(Color.LIGHT_GRAY,Color.GRAY,new Color(0xB9D7FC),1,7);
